...
ufw <span class="token builtin class-name">enable</span></code>`),n(D);var R=a(D,8),hs=a(s(R));m(hs,{href:"https://letsencrypt.org/",children:(t,h)=>{e();var o=d("Let’s Encrypt");l(t,o)}}),e(),n(R);var G=a(R,4),ys=s(G);c(ys,()=>'<code class="language-shell"><span class="token function">apt</span> <span class="token function">install</span> certbot</code>'),n(G);var $=a(G,4),fs=s($);c(fs,()=>'<code class="language-shell">certbot certonly <span class="token parameter variable">--standalone</span> --config-dir /mnt/nginx/ssl/config --work-dir /mnt/nginx/ssl --logs-dir /mnt/nginx/logs <span class="token parameter variable">-d</span> yourdomain.com </code>'),n($);var V=a($,4),vs=a(s(V));m(vs,{href:"https://docs.portainer.io/",children:(t,h)=>{e();var o=d("Portainer CE");l(t,o)}}),e(),n(V);var O=a(V,4),gs=s(O);c(gs,()=>`<code class="language-shell"><span class="token function">apt</span> <span class="token function">install</span> docker.io <span class="token function">docker-compose</span>
systemctl <span class="token builtin class-name">enable</span> <span class="token parameter variable">--now</span> <span class="token function">docker</span></code>`),n(O);var U=a(O,4),bs=s(U);c(bs,()=>`<code class="language-yaml"><span class="token key atrule">services</span><span class="token punctuation">:</span>
...
<span class="token key atrule">volumes</span><span class="token punctuation">:</span> <span class="token comment"># If you want to store the data on a different drive, see https://github.com/nextcloud/all-in-one#how-to-store-the-filesinstallation-on-a-separate-drive</span>
  <span class="token key atrule">nextcloud_aio_mastercontainer</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">driver_opts</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">o</span><span class="token punctuation">:</span> bind</code>`),n(U);var L=a(U,4),_s=s(L);c(_s,()=>`<code class="language-nginx"><span class="token directive"><span class="token keyword">user</span>  nginx</span><span class="token punctuation">;</span>
